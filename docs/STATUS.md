...
- **FD hallucination tracking (2026-07-04):** Surrounded by Foes (FD p.55) now records the affected hero, displays a visible exploration status badge, and ticks the d3+1 duration down after combat rounds only.
