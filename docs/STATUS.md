...
- **TAG Treasure Map cave progress pass (2026-06-30):** Underground caves room targets now show a cave progress panel in the Current Objective and generated closeout areas. When the recorded target appears reached, the Current Objective switches to the destination-room closeout guidance for final Boss +2 Life, double maximum treasure, XP, Guild share, banking/storage, and signoff.
