...
- TAG remaining full adventure content expansion for deeper automatic scene insertion/removal, exact PDF combat modifiers for Guild spell markers, automatic Guild closeout prompts/leaving restrictions, and broader playtest sign-off;
