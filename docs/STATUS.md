...
- TAG remaining full adventure content expansion for deeper automatic scene insertion/removal, exact PDF combat modifiers for Guild spell markers, exact Guild leaving-restriction enforcement, and broader playtest sign-off;
