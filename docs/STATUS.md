...
- **Generated TAG readability / social-finale pass (2026-07-02):** Generated TAG prompts now avoid generic "final scene closeout" and reward-note wording when a lead profile has specific actions. Rumor 6, Leprechauns at Blackbird Hill, is now a vendor/social finale: no proxy Goblins are spawned, the objective completes by reaching the bargain scene, the complication room is narrative only, and the final actions show **Buy Shoes of Fast Walk** and **Learn illusion spell** with the checked Scene 2 cost/free conditions. Older saved logs translate stale leprechaun complication/final-guidance text into clearer player-facing wording.
