...
- **Hirelings (Abyss):** Expert tier unlocks the camp hirelings panel — max 2 retainers (#5–#6), max 3 professional services/camp, combat attacks, morale (hero/retainer death, petrify, insanity), treasure share, resurrection, porter cargo return on clean exit, loadout enforcement, spear sidearm, optional bodyguard intercept and acolyte Blessing preservation. **Alchemist professional:** 8 potions, commission at camp (50gp + material), d6 completion on adventure exit. Home **hirelings_table** (10 retainers + 10 professionals + 8 potions). Poison Expert not yet cataloged.
