...
- **Engine deferred** — rulebook validation on all 72 tiles. Citadel type modifiers and side sheet MVP are live — see [FORSAKEN_DEPTHS_ENGINE.md](FORSAKEN_DEPTHS_ENGINE.md).
