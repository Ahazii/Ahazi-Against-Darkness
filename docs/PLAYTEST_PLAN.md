...
Last updated: 2026-07-15. Target build: post-v0.39.17 FD spider reaction / Citadel return-marker / Greater Mutated Goblin loot follow-up patch.
...
5. Force or naturally encounter **Greater Mutated Goblin** once if convenient. After defeating it, claim the treasure and confirm the app stages 2d6 small gems worth 25gp each, 5d6gp, and one masterwork edged weapon worth `(d6+4)x5`gp. Treat the corrosive mucus/Tier-damage attack as still under review unless the log explicitly shows it.
