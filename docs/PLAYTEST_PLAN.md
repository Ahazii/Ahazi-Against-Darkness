...
Last updated: 2026-07-21. Target build: v0.39.38 developer inventory grants, explicit Bags of Carrying, and Invisible Gremlins.
...
1. Deploy `v0.39.38` from `main` to Unraid at `http://192.168.1.55:8001`.
2. Force-refresh until the app header reports `v0.39.38`.
