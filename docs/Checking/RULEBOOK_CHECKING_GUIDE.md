...
| TAG.2 | Medusa rumor exact foe and Scene 10 procedure | TAG pp.6-8, 22, 25-26, 28 | Rumor Scene Detail `2` | Scene 10 rolls one exploding L6 group Stealth Save with the lowest living-party modifier; this is one party roll, not one roll per hero. Narrative/UI list every hero's modifier and identify the controlling modifier. Failure stores d3+2 HCL+2 dagger agents and presents two clearly separated choices: a labelled actor selector for the L5 Streetwise Save, or immediate combat with the party acting first. Failed Streetwise gives the agents first action; victory stages 4d6 gp. Final room is Xasartha's cabin; Scene 1 choices appear before combat; Xasartha spawns only when the printed result says combat starts |
