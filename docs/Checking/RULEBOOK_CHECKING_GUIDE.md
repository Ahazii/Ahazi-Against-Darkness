...
| TAG.2a | Daroc's Lost Familiar typed Scene 5 | TAG p.27, Scene 5; Crucible of Classic Critters pp.11-15 for future class/companion integration | Rumor Scene Detail `9` | Settlement Look for Clues successes carry a town-source marker. Scene 5 counts only those marked Clues, requires two or one with a Druid, Beastmaster, cat-like hero, or cat animal companion, lists eligible holders, lets the player choose the living 100gp recipient, spends the exact eligible Clues, and adds one pending XP roll. Save/resume must not duplicate the result. |
