...
| TAG.2 | Medusa rumor exact foe and Scene 10 procedure | TAG pp.6-8, 22, 25-26, 28 | Rumor Scene Detail `2` | Scene 10 rolls one exploding L6 group Stealth Save with the worst living-party modifier; Shield/Heavy Armor penalties apply; failure stores d3+2 HCL+2 dagger agents and offers actor-selected L5 Streetwise or immediate combat with printed initiative and 4d6 gp. Final room is Xasartha's cabin; Scene 1 choices appear before combat; Xasartha spawns only when the printed result says combat starts |
