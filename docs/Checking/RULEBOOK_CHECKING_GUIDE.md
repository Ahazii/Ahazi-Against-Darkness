...
| TAG.2 | Medusa rumor exact foe and typed Scene 10/1 procedures | TAG pp.6-8, 22, 25-26, 28; EE pp.101, 162 | Rumor Scene Detail `2` | Scene 10 rolls one exploding L6 group Stealth Save with the lowest living-party modifier; this is one party roll, not one roll per hero. Narrative/UI list every hero's modifier and identify the controlling modifier. Failure stores d3+2 HCL+2 dagger agents and presents a labelled L5 Streetwise actor selector or immediate combat with the party acting first. Failed Streetwise gives the agents first action; victory stages 4d6 gp. Final room is Xasartha's cabin; Scene 1 choices appear before combat and Xasartha spawns only when the printed result says combat starts. A persisted reaction `2 quest` presents Accept/Refuse without rerolling; acceptance rolls the EE Quest Table and refusal lets Xasartha leave. An accepted Bring Gold Quest shows its exact stored amount, party total, and Quest-giver turn-in; exact payment clears the core Quest and awards one Epic Reward. The encounter remains peaceful, grants no combat treasure, and offers Return to town and finish instead of generic generated-lead guidance |
