...
| TAG.12 | Trinkets and Guild spells | TAG pp.61-66 | TAG Actions → Trinket / Guild spell | Carried trinkets/scrolls are consumed where present; Speedy Recovery marks settlement healing at 2 Life/day; Look Tough is consumed on the next Streetwise roll; Wizard's Luck modifies Gambling House resolution; Troupe Switch, Silence, and weapon enchantment markers are applied and logged |
