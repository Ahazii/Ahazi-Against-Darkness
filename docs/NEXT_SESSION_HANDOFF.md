...
- Resume disposable session `003f51881ebc417a8a70891da9e0de00` if still active, or start a fresh EE+Abyss+FD Game 2. First confirm a Soulbound hero shows the `FD Soulbound:<tile id>` chip/State Registry match and that moving away exposes **Lose 1 Life** / **Gain 1 Madness** Soulbinding buttons before movement continues. Do not repeat Spore Spiders, Deep Cave Spiders, Greater Mutated Goblin, or the stale Citadel marker check unless a later regression reopens them. The latest Citadel of Traps evidence already showed a Minions/Hordes replacement created a concrete active trap with **Resolve Trap**; next resolve that trap and continue the remaining Citadel save/return checks.
