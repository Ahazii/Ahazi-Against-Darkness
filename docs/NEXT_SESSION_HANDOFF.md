...
- Resume Forsaken Depths Game 2 if still active, or start a fresh disposable FD Game 2. First force **FD foe encounter -> Vermin -> Spore Spiders** once to confirm the named reaction table, fight-to-death, no morale flee, and 4-in-6 surprise logging. Then force/continue **Citadel of Traps** until a Minions/Hordes room-content result is eligible for the FD p.60 trap-replacement check and resolve one concrete trap if it appears.
