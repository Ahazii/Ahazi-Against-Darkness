...
- Complete the whole-book Abyss audit. The profile, dedicated procedural
  runtime, and first exact trap/feature/event pass are now started; exact
  multiple-boss/horde rules, item use-actions, diseases/transformations, and
  campaign plots remain before treating Abyss as complete.
