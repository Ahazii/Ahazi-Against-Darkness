...
- Release gate: Campaign/Rumor Continuity and Developer Grant/Two Bags passed. Deploy and complete only the short `v0.39.42` ordinary Invisible Gremlins checklist in `docs/PLAYTEST_PLAN.md`. Once it passes, stop broad adventure regression testing; reopen only the exact failed workflow if a defect is found.
