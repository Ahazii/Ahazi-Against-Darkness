...
- **TAG Treasure Map playthrough audit phase (2026-06-30):** All six generated Treasure Map destinations now carry app-owned destination guidance, prompt checklists, procedure/reward/storage closeout reminders, dedicated Go Adventure map audit/signoff panels, and Tables/Rules Reference entries. Next large TAG chunk should apply the same audit depth to Thematic Dungeon playthroughs, then Guild Jobs.
