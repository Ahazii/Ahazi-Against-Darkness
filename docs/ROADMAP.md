...
- [ ] Force-refresh and resume preserved session `fc741849402d46e096b2efa52368de8f` on v0.39.72. Confirm Sir Benedict shows 0gp carried + 600gp banked = 600gp available, exercise and reset both horizontal dividers, then run his bank-funded automatic training result, Done, and Continue. Camp return, the route, transfers, and Rumor 6 already passed; do not replay them.
