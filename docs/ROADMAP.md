...
- **Active registry tooltips (2026-07-08):** Adventure View status chips and Play Context terrain lines now surface matching State/Terrain Registry metadata in hover text so playtesters can see source, scope, and migration context without changing current mechanics.
