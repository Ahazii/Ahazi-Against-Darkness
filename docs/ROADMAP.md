...
- Release gate: Campaign/Rumor Continuity passed. Deploy and complete the short `v0.39.39` developer-grant / two-Bag / ordinary Invisible Gremlins checklist in `docs/PLAYTEST_PLAN.md`. Once it passes, stop broad adventure regression testing; reopen only the exact failed workflow if a defect is found.
