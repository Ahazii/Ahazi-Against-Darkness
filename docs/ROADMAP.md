...
- [ ] Resume preserved session `fc741849402d46e096b2efa52368de8f` after deploying v0.39.70 to validate the divider in both directions, internal scrolling, save/resume, skip-training Done, and Continue. Its shared opening and transition to Scene 3 already passed; no current hero is both eligible and funded, so paid-batch behavior remains automated until a natural future opportunity.
