...
- [ ] Force-refresh and resume preserved session `fc741849402d46e096b2efa52368de8f` on v0.39.71. Confirm **Return to dungeon** reaches the entrance without repeating Investigate, follow the explored route back to Scene 3, then run Sir Benedict's funded 600gp automatic training result, Done, and Continue. The divider correction and camp transfers already passed; do not replay the opening or Rumor 6.
