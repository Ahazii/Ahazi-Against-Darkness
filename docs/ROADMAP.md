...
- **TAG Rumor playthrough audit phase (2026-06-30):** All twelve generated Rumor leads now carry app-owned scene guidance, prompt checklists, and route/reward/XP closeout reminders. Go Adventure has dedicated Rumor audit/signoff panels and Tables/Rules Reference entries. Next large TAG chunk should apply the same audit depth to Treasure Map destinations and then Thematic Dungeon/Guild Job playthroughs.
