...
- **Registry resolver helpers (2026-07-08):** Backend State and Terrain Registry modules now have read-only matching helpers for legacy status labels and terrain context, giving future supplement loaders a tested reuse point before state-instance mutation exists.
