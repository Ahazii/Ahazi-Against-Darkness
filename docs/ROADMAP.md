...
- Completed TAG conversion slice: v0.39.53 closes the accepted Rumor 2 Scene 1 `d6=2 quest` route after its core Expanded Edition Quest is completed. Live verification passed: the generated lead resolved peacefully, preserved its one Epic Reward, and returned to town without combat treasure or rerolls. The next bounded slice is TAG pp.25-26 Scene 1/6: bribe payment, fight/fight-to-the-death, 260gp pendant plus 2d6 necros after defeat, try-on versus sell choice, and rechargeable pendant Luck. Do not build a generic prose interpreter or expose printed success/failure outcomes as player choices.
