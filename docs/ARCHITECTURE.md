...
- `src/app/engine/quest_rewards.py` - Lady in White Quest acceptance plus core turn-in validation, Epic Reward table claim, payment, inventory gates, and reward state effects
