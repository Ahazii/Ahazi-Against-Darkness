...
- `src/app/engine/treasure_awards.py` - reusable defeated-group roll planning, outcome merging, and Final Boss/secret-door treasure integrity helpers
...
- `src/app/engine/tile_geometry.py` - rotation, exit spans, authored portal tracing, grid fallback, occupancy, visibility, and placement geometry shared by random and authored tiles
