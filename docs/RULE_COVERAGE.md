...
| Special events | starter | Ghost, trap, healer (once per adventure reroll), alchemist, Lady in White, wandering subtable; caverns/fungal environment tables. Special-feature state changes log targeted `Effect:` lines, including the affected hero, and remain visible in Summary log mode. |
