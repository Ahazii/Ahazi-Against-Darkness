...
| Combat modifiers | starter | Blade poison, poison foes, two-step MR (connect + penetrate tiers; magic_resist/caster/dragon tiers stack and show on foe chips), mirror-image absorption, subdual, bribes, missiles, weapon-type modifiers; troll regeneration (fire, acid vials, lightning, lantern oil suppress regen), held/fog/specter combat effects; post-round log summary names hero/foe damage, kills, and wounds taken instead of aggregate party Life loss; multi-target spell/ability UI (Double Attack, Double Kick, Protective Incense, Infallible L8+). |
