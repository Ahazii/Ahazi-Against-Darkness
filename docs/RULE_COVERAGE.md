...
- Automated checks: `tests/test_rulebook_validation.py`, `tests/test_combat.py`,
  ...
  `tests/test_tier_dice.py`, `tests/test_tier_training.py`, `tests/test_expert_skills.py`, `tests/test_expert_skill_effects.py`, `tests/test_expert_spells.py`
...
4. Combat round log summary; multi-target spell UI.
