...
| Rules reference | validated | Searchable rulebook sections (~109 entries): EE + Abyss topics with `implementation_status` badges; skill/spell catalogs and wiring live in Rules tables only. |
