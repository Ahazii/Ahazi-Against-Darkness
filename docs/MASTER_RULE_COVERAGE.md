...
- first eighteen TAG treasure/service rows (through flammable oil), with hidden-trove risk roll, treasure-map price, moneylender pursuit, and row-level availability checks;
