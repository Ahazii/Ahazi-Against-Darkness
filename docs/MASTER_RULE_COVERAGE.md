...
- complete the short v0.39.38 developer-grant / explicit Bag / Invisible Gremlins live check (Campaign/Rumor Continuity is passed), then stop broad adventure testing and resume one bounded modularisation slice at a time.
