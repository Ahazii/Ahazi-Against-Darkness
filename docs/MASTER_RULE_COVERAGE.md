...
- first twelve TAG treasure/service rows (bank accounts, inheritance, magic lockers, platinum exchange, hidden treasure troves, resurrection/blessing tags, gems/jewelry, Bag of Carrying, 10-foot pole, lantern hook, very nutritious food, poison resistance training), with hidden-trove risk roll and row-level availability checks;
