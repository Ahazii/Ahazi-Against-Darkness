...
class SessionState(BaseModel):
    ...
    active_tile_ids: list[str] = Field(default_factory=list)
    active_class_ids: list[str] = Field(default_factory=list)
    active_item_ids: list[str] = Field(default_factory=list)
    declared_content_sources: list[dict[str, str]] = Field(default_factory=list)
    ...
    tile_catalog_version: int = Field(default=0, ge=0)
    class_catalog_version: int = Field(default=0, ge=0)
    item_catalog_version: int = Field(default=0, ge=0)
...
class SessionAction(BaseModel):
    ...
    exit_id: str | None = None
    playtest_kind: Literal["abyss_foe", "abyss_unique_event", "fd_foe", "fd_citadel", "ee_foe", "ee_final_boss", "ee_quest"] | None = None
    ...
    special_feature_choice: Literal[
        ...
        "leap_abyss_lava",
        "leave_abyss_lava",
        "free_abyss_chained_monster",
        "kill_abyss_chained_monster",
        "leave_abyss_chained_monster",
        "research_abyss_repository",
        "leave_abyss_repository",
        "attempt_abyss_puzzle",
        "leave_abyss_puzzle",
        "read_abyss_book",
        "leave_abyss_book",
        "cast_fireball_abyss_swarm",
        "endure_abyss_swarm",
        "take_abyss_stairs",
        "leave_abyss_stairs",
        "pay_abyss_gold_ghost",
        "refuse_abyss_gold_ghost",
    ] | None = None
    ...
    treasure_outcome_choice: (
        Literal[
            ...
            "masterwork_crossbow",
            "masterwork_sling",
            "masterwork_two_handed_weapon",
            "masterwork_edged_sword",
            "masterwork_edged_axe",
            "masterwork_edged_spear",
            "masterwork_edged_dagger",
            "masterwork_edged_two_handed_weapon",
            "silver_melee",
            "silvered_sword",
            "silvered_axe",
            "silvered_spear",
