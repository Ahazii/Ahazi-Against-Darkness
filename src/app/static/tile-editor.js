...
const CELL_SHAPE_DESCRIPTIONS = {
  ...
  f: "Half top blocked, flat straight edge",
  j: "Half top blocked, shallow semicircle curve on boundary",
  k: "Half top blocked, medium semicircle curve on boundary",
  l: "Half top blocked, deep semicircle curve on boundary",
  z: "Half top blocked, convex curve (more walkable at center)",
  m: "Half bottom blocked, flat straight edge",
  n: "Half bottom blocked, shallow semicircle curve on boundary",
  o: "Half bottom blocked, medium semicircle curve on boundary",
  p: "Half bottom blocked, deep semicircle curve on boundary",
  Z: "Half bottom blocked, convex curve (more walkable at center)",
  q: "Half left blocked, flat straight edge",
  r: "Half left blocked, shallow semicircle curve on boundary",
  s: "Half left blocked, medium semicircle curve on boundary",
  t: "Half left blocked, deep semicircle curve on boundary",
  y: "Half left blocked, convex curve (more walkable at center)",
  u: "Half right blocked, flat straight edge",
  v: "Half right blocked, shallow semicircle curve on boundary",
  w: "Half right blocked, medium semicircle curve on boundary",
  x: "Half right blocked, deep semicircle curve on boundary",
  1: "Half right blocked, convex curve (more walkable at center)",
