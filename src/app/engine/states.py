...
STATE_DEFINITIONS: list[dict[str, Any]] = [
    {
        ...
        "ui": {"label": "Dark Plague", "hover": "Abyss p.37 disease. Roll d8 on every room entry; on 1 lose 1 Life. It can spread to non-immune allies on the next room entry."},
    },
    {
        ...
        "implemented": True,
        "review_status": "source_backed",
        "ui": {"label": "Dark Plague immunity", "hover": "Abyss p.37. A successful initial save, Blessing cure, or Elven Bread cure prevents Dark Plague for the remainder of this adventure only."},
    },
    {
