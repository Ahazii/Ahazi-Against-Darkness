...
CLASS_TRICKS_IMPLEMENTATION: list[dict[str, str]] = [
    {"tier": "1", "class": "Barbarian", "ability": "Rage", "status": "wired", "mechanic": "3d6 keep best; double damage on hit.", "source_page": "24"},
    {"tier": "1", "class": "Halfling", "ability": "Luck", "status": "wired", "mechanic": "Reroll attack, defense, save, treasure, or search.", "source_page": "40"},
    {"tier": "1", "class": "Swashbuckler", "ability": "Panache", "status": "wired", "mechanic": "+1 attack or defense; gain on kills.", "source_page": "61"},
    {"tier": "1", "class": "Paladin", "ability": "Prayer points", "status": "wired", "mechanic": "Targeted heal selector, failed-save reroll, or summon steed.", "source_page": "55"},
    {"tier": "2", "class": "Acrobat", "ability": "Shift Position / Distract / Evade / Double Kick / Flip Kick", "status": "wired", "mechanic": "Shift/Distract expose explicit ally/foe target selectors.", "source_page": "19"},
    {"tier": "2", "class": "Acrobat", "ability": "Leap out of Harm / Serpent Twist", "status": "wired", "source_page": "19"},
    {"tier": "2", "class": "Acrobat", "ability": "Knife Throw (+Tier ranged)", "status": "wired", "mechanic": "Spend 1 Trick; ignores light weapon −1.", "source_page": "19"},
    {"tier": "2", "class": "Assassin", "ability": "Hide in Shadows", "status": "wired", "source_page": "22"},
    {"tier": "2", "class": "Illusionist", "ability": "Distracting Lights", "status": "wired", "mechanic": "All minions in group; no slot.", "source_page": "42"},
    {"tier": "2", "class": "Illusionist", "ability": "Continual Light", "status": "wired", "mechanic": "Hands-free light on worn item.", "source_page": "42"},
    {"tier": "2", "class": "Illusionist", "ability": "Illusionary Knife Throw", "status": "wired", "mechanic": "Spend 1 spell slot; +Tier+L ranged.", "source_page": "42"},
    {"tier": "2", "class": "Gnome", "ability": "Smokescreen / gadget attack / door / trap", "status": "wired", "source_page": "36"},
    {"tier": "2", "class": "Gnome", "ability": "Free prisoner (gadget)", "status": "wired", "mechanic": "Save vs L6 to free ally from restraints.", "source_page": "36"},
    {"tier": "2", "class": "Mushroom monk", "ability": "Spore cloud", "status": "wired", "source_page": "53"},
    {"tier": "2", "class": "Light gladiator", "ability": "Dual wield / Parry / Counter-strike", "status": "wired", "source_page": "47"},
    {"tier": "2", "class": "Paladin", "ability": "Summon Steed (+1 mounted outdoors)", "status": "wired", "source_page": "55"},
    {"tier": "2", "class": "Swashbuckler", "ability": "Dual wield + Panache", "status": "wired", "source_page": "61"},
    ...
    {"tier": "—", "class": "Kukla", "ability": "Rings / Secret compartment", "status": "wired", "mechanic": "Green ring revives selected fallen kukla; red ring poisons selected foe; torso compartment stash (theft-proof).", "source_page": "44"},
]
