...
TAG_RUMOR_PROFILES: dict[int, dict[str, object]] = {
    ...
    4: {
        ...
        "rules": [
            "All living heroes Save vs L5; chaos-tainted heroes fail automatically.",
            "A rescue costs one turn. Every trapped hero loses 1 Life, the chosen victim is moved out, and a failed rescuer Save puts the rescuer into the water.",
            "If nobody remains able to rescue, the party is destroyed.",
            "Survival yields d6+3 Food rations to keep or sell and counts as two minion encounters for XP.",
        ],
    },
    5: {
